...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
		...
		vector<VertexFormat> vertices2
		{
			...
			VertexFormat(glm::vec3(2, 0,  2), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
			//VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
		};

		vector<VertexFormat> vertices3
		{
			VertexFormat(glm::vec3(5, 0,  2), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
			// TODO(student): Complete the vertices data for the cube mesh
			VertexFormat(glm::vec3(5, 0,  1), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(3, 0,  1), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(3, 0,  2), glm::vec3(0, 1, 1), glm::vec3(1, 0, 0)),
			//VertexFormat(glm::vec3(1, 1,  1), glm::vec3(0, 1, 1), glm::vec3(0.2, 0.8, 0.6)),
		};
...
void Lab2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube_B"], shaders["VertexNormal"], glm::vec3(2.5f, 0.5f, -2), glm::vec3(0.5f));

    // TODO(student): Draw the tetrahedron
	RenderMesh(meshes["tetraedru"], shaders["VertexNormal"], glm::vec3(0.5f, 0.5f, 1), glm::vec3(0.5f));

    // TODO(student): Draw the square
	RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(1, 0.5f, 2), glm::vec3(0.5f));
