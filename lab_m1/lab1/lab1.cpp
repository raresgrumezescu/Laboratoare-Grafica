...
void Lab1::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["box"], glm::vec3(locX, locY, locZ));
	...
	RenderMesh(meshes["teapot"], glm::vec3(-3, 0.3f, 2));

	RenderMesh(meshes["sphere"], glm::vec3(2, 1, 0.5f), glm::vec3(0.5f));

	RenderMesh(meshes["sphere"], glm::vec3(3, 2, 2));

	RenderMesh(meshes["sphere"], glm::vec3(-1, 2, 3));
