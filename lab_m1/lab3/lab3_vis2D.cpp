...
void Lab3_Vis2D::Init()
{
	...
	Mesh* square2 = object2D::CreateSquare("square2", corner, length, glm::vec3(0, 1, 0));
...
void Lab3_Vis2D::DrawScene(glm::mat3 visMatrix, double plx, double ply)
{
//    modelMatrix = visMatrix * transform2D::Translate(1, 0);
//    RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * transform2D::Translate(1.2, 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * transform2D::Translate(1.4, 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * transform2D::Translate(1.6, 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);

	modelMatrix = visMatrix * transform2D::Translate(1.8, 0);
	RenderMesh2D(meshes["square1"], shaders["VertexColor"], modelMatrix);
